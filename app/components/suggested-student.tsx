...
export default function SuggestedStudent({ student, currentId, isFollowing, reason }: { student: StudentProfile; currentId: string; isFollowing: boolean; reason?: string }) {
  return (

...
export default function SuggestedStudent({ student, currentId, isFollowing, mutualContext, reason }: { student: StudentProfile; currentId: string; isFollowing: boolean; mutualContext?: MutualFollowContext | null; reason?: string }) {
  return (
    <div className="flex items-start gap-3 py-3">
      ...
      <div className="min-w-0 flex-1">
        ...
        {reason && <p className="mt-1 text-[11px] leading-4 text-subtle">{reason}</p>}

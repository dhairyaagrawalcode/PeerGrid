...
export default function SuggestedStudent({ student, currentId, connection }: { student: StudentProfile; currentId: string; connection?: ConnectionRecord }) {
  return (
    <div className="flex items-start gap-3 py-3">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-2"><ConnectionControls compact connection={connection} currentId={currentId} targetId={student.id} /></div>
      </div>
    </div>
  );
}

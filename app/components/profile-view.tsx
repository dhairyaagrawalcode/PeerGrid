  ...
  return (
    <div className="space-y-5 ">
      <section className="surface overflow-hidden">
        ...
        <div className="px-5 pb-6 sm:px-7">
          <div className="-mt-10 flex items-end justify-between gap-4">
            <div className="avatar !h-20 !w-20 !rounded-2xl !border-4 !border-panel text-xl">
              {profile.avatar_url ? (
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2">
            ...
            <span className="chip !border-secondary/15 !bg-secondary/8 !text-secondary">
              <FiShield /> Verified
            </span>
          </div>
          ...
          <div className="mt-3 flex gap-5 text-sm text-muted">
            <span>
              ...
              follower{followSummary.follower_count === 1 ? "" : "s"}
            </span>
            <span>
              <strong className="text-font">
          ...
          {profile.bio && (
            <p className="mt-5 max-w-2xl text-sm leading-6 text-[#d3d7df]">
              {profile.bio}
            </p>
          )}
          <div className="mt-5 flex flex-wrap gap-3">
            {profile.github_url && (
              <a
                className="button button-ghost !min-h-9 !px-3 !text-xs"
      ...
      <section className="surface p-5">
        ...
        <p className="mt-4 text-sm leading-6 text-[#d3d7df]">

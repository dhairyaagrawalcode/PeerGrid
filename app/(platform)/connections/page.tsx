...
export default async function ConnectionsPage({ searchParams }: { searchParams: Promise<{ view?: string; followersPage?: string; followingPage?: string }> }) {
  ...
  return (
    <div className="app-page">
      <p className="mobile-hide eyebrow">Your network</p><h1 className="mobile-hide mt-2 text-2xl font-black tracking-tight sm:text-3xl">Followers &amp; following</h1><p className="mobile-hide mt-2 text-sm text-muted">Students who follow you and people you follow.</p>
